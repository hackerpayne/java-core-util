...
public class JavaInfo {
    ...
    private final String JAVA_VERSION = QySystemUtil.get("java.version", false);
    private final float JAVA_VERSION_FLOAT = getJavaVersionAsFloat();
    private final int JAVA_VERSION_INT = getJavaVersionAsInt();
    private final String JAVA_VENDOR = QySystemUtil.get("java.vendor", false);
    private final String JAVA_VENDOR_URL = QySystemUtil.get("java.vendor.url", false);
    ...
    public final String toString() {
        ...
        QySystemUtil.append(builder, "Java Version:    ", getVersion());
        QySystemUtil.append(builder, "Java Vendor:     ", getVendor());
        QySystemUtil.append(builder, "Java Vendor URL: ", getVendorURL());
