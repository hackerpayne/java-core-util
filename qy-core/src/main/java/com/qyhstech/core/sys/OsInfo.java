...
public class OsInfo {
    ...
    private final String OS_VERSION = QySystemUtil.get("os.version", false);
    private final String OS_ARCH = QySystemUtil.get("os.arch", false);
    private final String OS_NAME = QySystemUtil.get("os.name", false);
    ...
    private final String FILE_SEPARATOR = QySystemUtil.get("file.separator", false);
    private final String LINE_SEPARATOR = QySystemUtil.get("line.separator", false);
    private final String PATH_SEPARATOR = QySystemUtil.get("path.separator", false);
    ...
    public final String toString() {
        ...
        QySystemUtil.append(builder, "OS Arch:        ", getArch());
        QySystemUtil.append(builder, "OS Name:        ", getName());
        QySystemUtil.append(builder, "OS Version:     ", getVersion());
        QySystemUtil.append(builder, "File Separator: ", getFileSeparator());
        QySystemUtil.append(builder, "Line Separator: ", getLineSeparator());
        QySystemUtil.append(builder, "Path Separator: ", getPathSeparator());
