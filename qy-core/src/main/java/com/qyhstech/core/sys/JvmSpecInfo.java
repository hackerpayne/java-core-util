...
public class JvmSpecInfo {
    ...
    private final String JAVA_VM_SPECIFICATION_NAME = QySystemUtil.get("java.vm.specification.name", false);
    private final String JAVA_VM_SPECIFICATION_VERSION = QySystemUtil.get("java.vm.specification.version", false);
    private final String JAVA_VM_SPECIFICATION_VENDOR = QySystemUtil.get("java.vm.specification.vendor", false);
    ...
    public final String toString() {
        ...
        QySystemUtil.append(builder, "JavaVM Spec. Name:    ", getName());
        QySystemUtil.append(builder, "JavaVM Spec. Version: ", getVersion());
        QySystemUtil.append(builder, "JavaVM Spec. Vendor:  ", getVendor());
