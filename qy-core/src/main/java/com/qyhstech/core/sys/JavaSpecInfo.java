...
public class JavaSpecInfo {
    ...
    private final String JAVA_SPECIFICATION_NAME = QySystemUtil.get("java.specification.name", false);
    private final String JAVA_SPECIFICATION_VERSION = QySystemUtil.get("java.specification.version", false);
    private final String JAVA_SPECIFICATION_VENDOR = QySystemUtil.get("java.specification.vendor", false);
    ...
    public final String toString() {
        ...
        QySystemUtil.append(builder, "Java Spec. Name:    ", getName());
        QySystemUtil.append(builder, "Java Spec. Version: ", getVersion());
        QySystemUtil.append(builder, "Java Spec. Vendor:  ", getVendor());
