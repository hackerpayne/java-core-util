...
public class JvmInfo {
    ...
    private final String JAVA_VM_NAME = QySystemUtil.get("java.vm.name", false);
    private final String JAVA_VM_VERSION = QySystemUtil.get("java.vm.version", false);
    private final String JAVA_VM_VENDOR = QySystemUtil.get("java.vm.vendor", false);
    private final String JAVA_VM_INFO = QySystemUtil.get("java.vm.info", false);
    ...
    public final String toString() {
        ...
        QySystemUtil.append(builder, "JavaVM Name:    ", getName());
        QySystemUtil.append(builder, "JavaVM Version: ", getVersion());
        QySystemUtil.append(builder, "JavaVM Vendor:  ", getVendor());
        QySystemUtil.append(builder, "JavaVM Info:    ", getInfo());
