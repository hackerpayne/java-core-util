...
public class QyJudge {
    ...
    public static boolean isValid(Object obj) {
        ...
        return switch (obj) {
            case Number number -> true; // 不为Null都是有效的
            case CharSequence s -> StrUtil.isNotBlank(s); // String is valid if it's not null and not empty
            case Collection<?> coll -> CollUtil.isNotEmpty(coll); // List is valid if it's not null and not empty
            case Map<?, ?> map -> MapUtil.isNotEmpty(map);
            case java.util.Date date -> true; // Date is valid if it's not null
            default -> {
    ...
    public static boolean isMobile(String mobile) {
        return QyRegex.isMatch(QyRegexPatterns.MOBILE, mobile);
    }
    ...
    public static boolean isFixedPhone(String fixedPhone) {
        return QyRegex.isMatch(QyRegexPatterns.PHONE, fixedPhone);
    }
    ...
    public static boolean isPostCode(String postCode) {
        return QyRegex.isMatch(QyRegexPatterns.ZIP_CODE, postCode);
    }
    ...
    public static boolean isNumber(String number) {
        return QyRegex.isMatch(QyRegexPatterns.NUMBERS, number);
    }
    ...
    public static String filterUnNumber(String str) {
        return QyRegex.replaceAll(str, QyRegexPatterns.NOT_NUMBERS, "");
    }
    ...
    public static boolean isDigit(String param) {
        return QyRegex.isMatch(QyRegexPatterns.NUMBERS, param);
    }
    ...
    public static boolean isZipCode(String param) {
        return QyRegex.isMatch(QyRegexPatterns.ZIP_CODE, param);
    }
    ...
    public static boolean isEmail(String param) {
        return param.matches(QyRegexPatterns.EMAIL2);
    }
    ...
    public static boolean isIdCardNo(String input) {
        return QyRegex.isMatch(QyRegexPatterns.CITIZEN_ID, input);
    }
    ...
    public static boolean isMoney(String param) {
        return QyRegex.isMatch(QyRegexPatterns.MONEY, param);
    }
