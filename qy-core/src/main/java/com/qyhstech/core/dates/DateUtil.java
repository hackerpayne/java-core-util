...
//        return cal.getTimeInMillis() / 1000;
    ...
    private static final ThreadLocal<SimpleDateFormat> threadLocalSDFTime = new ThreadLocal<SimpleDateFormat>() {
        ...
        protected SimpleDateFormat initialValue() {
            return new SimpleDateFormat(QyDatePattern.DATE_TIME_FORMAT);
        }
    };
    ...
    private static final ThreadLocal<SimpleDateFormat> threadLocalSDFDate = new ThreadLocal<SimpleDateFormat>() {
        @Override
        protected SimpleDateFormat initialValue() {
            return new SimpleDateFormat(QyDatePattern.DATE_FORMAT);
        }
    };
    ...
    public static String getNowTime(String timeFormat) {
        SimpleDateFormat simpleDateFormat = new SimpleDateFormat(QyDatePattern.DATE_TIME_FORMAT);
    ...
    public static String toLocalTime(String unix) {
        return toLocalTime(unix, QyDatePattern.DATE_TIME_FORMAT);
    }
    ...
    public static String toUnixTime(String local) {
        return toUnixTime(local, QyDatePattern.DATE_TIME_FORMAT);
    }
    ...
    public static int dateDiffNextHour() {
        ...
        SimpleDateFormat df = new SimpleDateFormat(QyDatePattern.DATE_TIME_FORMAT);
    ...
    public static Calendar dateToCalendar(Date inputDate) {
        return QyDateOld.calendar(inputDate);
...
//按照传入的格式生成一个simpledateformate对象
    ...
    public static Date getYesterday(String dateStr) {
        return getYesterday(dateStr, QyDatePattern.DATE_FORMAT);
    }
...
//            date = DateUtils.parseDate(input, parsePatterns);
            date = QyDateOld.parse(input, parsePatterns);
        } catch (Exception e) {
            e.printStackTrace();
        }
        return date;
