...
public enum QyDateFormatsType {
    ...
    public static QyDateFormatsType getFormatsType(String str) {
        for (QyDateFormatsType value : values()) {
            if (StrUtil.contains(str, value.getTimeFormat())) {
                return value;
            }
        }
