...
public interface QyAttr extends Serializable {

    /**
     * 获取属性 这里可用做覆盖已设置的信息属性。
     *
     * @return 属性
     */
     ...
     * @param value 值
     */
    default void addAttr(String key, Object value) {
    ...
    default LocalDateTime getAttrForLocalDateTime(String key) {
        return (LocalDateTime) getAttr(key);
    }
}
