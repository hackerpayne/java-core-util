 ...
 * </p>
 */
public class ModelPage extends QyBaseEntity {
    ...
    public ModelPage(Integer totalCount) {
        this.totalCount = totalCount;
        caculatePage();
    }

    public ModelPage(Integer totalCount, Integer pageSize) {
        this.totalCount = totalCount;
...
//        return (int) Math.ceil((double) totalCount / pageSize);
    ...
    public static void main(String[] args) {
        ...
        modelPage.setTotalCount(1002);
        modelPage.setPageSize(10);
        System.out.println(modelPage);

        // 测滑动窗口
        modelPage.setPageCurrent(36);
        System.out.println(modelPage);

        // 改页码
        modelPage.setPageCurrent(2);
        System.out.println(modelPage);

        // 改页面大小
        modelPage.setPageSize(100);
        System.out.println(modelPage);

        // 改总数
        modelPage.setTotalCount(109);
        System.out.println(modelPage);
