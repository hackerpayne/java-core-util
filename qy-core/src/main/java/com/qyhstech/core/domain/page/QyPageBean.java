package com.qyhstech.core.domain.page;
...
//        return pageBean;
//        }
public class QyPageBean<T> extends QyBaseEntity {
    ...
    public QyPageBean(Integer pageNumber) {
     ...
     * @param pageSize
     */
    public QyPageBean(Integer pageNumber, Integer pageSize) {
        this.curPage = pageNumber;
     ...
     * @param totalCount
     */
    public QyPageBean(List<T> listData, Integer pageNumber, Integer pageSize, Integer totalCount) {
        this.data = listData;
        this.curPage = pageNumber;
        this.pageSize = pageSize;
    ...
    public QyPageBean setData(List<T> data) {
        this.data = data;
        return this;
    }
    ...
    public QyPageBean setNextPage(int nextPage) {
    ...
    public QyPageBean setCurPage(int curPage) {
    ...
    public QyPageBean setTotalCount(int totalCount) {
        this.totalCount = totalCount;
        return this;
    }
