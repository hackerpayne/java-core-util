 ...
 */
@Slf4j
public class QyCsrfTokenUtil {

    private static final QyCsrfTokenUtil instance = new QyCsrfTokenUtil();

    HttpServletRequest request = null;

    private QyCsrfTokenUtil() {
    }
     ...
     * @return
     */
    public static QyCsrfTokenUtil getInstance() {
        return instance;
    }
    ...
    public String makeToken(String userId) {  //checkException
        ...
        String token = (System.currentTimeMillis() + new Random().nextInt(999999999)) + "" + (StrUtil.isNotEmpty(userId) ? userId : "");
