...
public class QyRand {
     ...
     * @return 随机数
     */
    public static int getRandIntBetween(int limit) {
     ...
     * @return bytes
     */
    public static byte[] getRandBytes(int length) {
    ...
    public static <T> T getRandFromList(List<T> list) {
        return getRandFromList(list, list.size());
    }
     ...
     * @return 随机元素
     */
    public static <T> T getRandFromList(List<T> list, int limit) {
        return list.get(getRandIntBetween(limit));
    }
     ...
     * @return 随机元素
     */
    public static <T> List<T> getRandListFromList(List<T> list, int count) {
        final List<T> result = new ArrayList<T>(count);
        int limit = list.size();
        while (--count > 0) {
            result.add(getRandFromList(list, limit));
        }
     ...
     */
    public static <T> Set<T> getRandUniqueFromList(Collection<T> collection, int count) {
        ...
        while (result.size() < count) {
            result.add(getRandFromList(source, limit));
        }
     ...
     * @return 随机字符串
     */
    public static String getRandStr(int length, boolean useUpper) {
        if (useUpper) {
            return getRandStr(BASE_CHAR_UPPER_NUMBER, length);
        }
        return getRandStr(BASE_CHAR_NUMBER, length);
    }
     ...
     * @return 随机字符串
     */
    public static String getRandNumbers(int length) {
        return getRandStr(BASE_NUMBER, length);
    }
     ...
     * @return 随机字符串
     */
    public static String getRandStr(String baseString, int length) {
    ...
    public static String getTraceId() {
        return DateTimeFormatter.ofPattern("yyMMddHHmmss").format(LocalDateTime.now()) + RandomUtil.randomNumbers(8);
    }
    ...
    public static String getOrderId(LocalDateTime localDateTime) {
        return QyDate.toStr(localDateTime, "yyyyMMddHHmmss") + getRandNumbers(4);
    }
