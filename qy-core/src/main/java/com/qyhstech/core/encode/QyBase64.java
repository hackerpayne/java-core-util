...
public class QyBase64 {
    ...
    public static String encodeToStr(String input) {
        return ENCODER.encodeToString(input.getBytes(QyCharset.CHARSET_UTF_8));
...
//        return new String(new Base64().decode(input), charset);
        return new String(DECODER.decode(input), QyCharset.CHARSET_UTF_8);
    }
...
//        return new String(new Base64().decode(input), charset);
    ...
    public static byte[] decode(String input) {
        return DECODER.decode(input.getBytes(QyCharset.CHARSET_UTF_8));
    }
