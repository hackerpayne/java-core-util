...
public class LocalDateUtilTest {
    ...
    public void getYesterdayStr() {
        System.out.println(QyDate.getYesterdayStr());
    }
    ...
    public void getTime() {
        ...
        System.out.println(QyDate.toStr(LocalDateTime.now().minusHours(1)));
    }
    ...
    public void fromUnixTime() {
        ...
        System.out.println(QyDate.unixTimeStampTo(time));
        System.out.println(QyDate.unixTimeStampTo(time2));
    }

    @Test
    public void toUnixTime() {
        System.out.println(QyDate.toUnixTimeShort());
        System.out.println(QyDate.toUnixTimeShort(LocalDateTime.now()));

        System.out.println(QyDate.toUnixTime());
        System.out.println(QyDate.toUnixTime(LocalDateTime.now()));
    }

    @Test
    public void parseStr() {
        LocalDateTime test = QyDate.toLocalDateTime("2019-04-08 23:32:32", QyDatePattern.DATE_TIME_FORMAT);
    ...
    public void getDatesBetweenUsingJava8() {
        ...
        List<LocalDate> betweens = QyDate.getDatesBetweenUsingJava8(startDate, endDate);
    ...
    public void betweenTest() {
        ...
        LocalDate endDate = LocalDate.now();
        List<String> betweens = QyDate.getDatesBetween(startDate, endDate);
        System.out.println(betweens);

        betweens = QyDate.getDatesBetween(startDate, endDate, QyDatePattern.DATE_SIMPLE_FORMAT);
        System.out.println(betweens);
    }
    ...
    public void testStartOfDay() {
        ...
        System.out.println(QyDate.getStartOfDay(LocalDateTime.now()));

        System.out.println("2");
        System.out.println(QyDate.getStartOfDayStr(LocalDateTime.now()));
    }

    @Test
    public void testEndOfDay() {
        System.out.println("1");
        System.out.println(QyDate.getEndOfDay(LocalDateTime.now()));

        System.out.println("2");
        System.out.println(QyDate.getEndOfDayStr(LocalDateTime.now()));
    }
