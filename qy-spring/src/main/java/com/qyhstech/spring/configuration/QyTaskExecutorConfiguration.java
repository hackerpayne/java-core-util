...
@Slf4j
public class QyTaskExecutorConfiguration implements AsyncConfigurer { //配置类实现AsyncConfigurer接口并重写getAsyncExcutor方法，并返回一个ThreadPoolTaskExevutor,就获得了一个基于线程池的TaskExecutor
